...
export function Home ({chairInfo}) {
    ...
    return(
        <div className="home">
            ...
            <div className="hero">
                <Link to={`/Chairs/${ch20.title}`}  state={{ch20}}><img src="/public/images/ch23-seite.png" className="hero-img" alt="ch23 chair"></img></Link>
                ...
                <Link to={`/Chairs/${ch23.title}`} state={{ch23}}><img src="/public/images/ch26-seite.png" className="hero-img" alt="ch26 chair"></img></Link>
            </div>
            <Rooms></Rooms>
